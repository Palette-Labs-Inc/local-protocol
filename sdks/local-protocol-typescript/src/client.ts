...
import {
  ...
  DeliveryUpdateEventParams,
} from './resources/deliveries';
import { EventVocabularies, EventVocabularyRetrieveResponse } from './resources/event-vocabularies';
...
export interface ClientOptions {
   ...
   * Set the log level.
   *
   * Defaults to process.env['LOCAL_PROTOCOL_LOG'] or 'warn' if it isn't set.
   */
...
export class LocalProtocol {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? LocalProtocol.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('LOCAL_PROTOCOL_LOG'), "process.env['LOCAL_PROTOCOL_LOG']", this) ??
      defaultLogLevel;
  ...
  static LocalProtocol = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static LocalProtocolError = Errors.LocalProtocolError;
...
LocalProtocol.WellKnown = WellKnown;
LocalProtocol.Healthz = Healthz;
LocalProtocol.Requests = Requests;
LocalProtocol.Deliveries = Deliveries;
LocalProtocol.Merchants = Merchants;
LocalProtocol.Orders = Orders;
LocalProtocol.EventVocabularies = EventVocabularies;
LocalProtocol.PaymentInstruments = PaymentInstruments;

export declare namespace LocalProtocol {
  export type RequestOptions = Opts.RequestOptions;

  export { WellKnown as WellKnown, type WellKnownRetrieveResponse as WellKnownRetrieveResponse };
  ...
  export { Orders as Orders, type Order as Order, type OrderCreateParams as OrderCreateParams };

  export {
    EventVocabularies as EventVocabularies,
    type EventVocabularyRetrieveResponse as EventVocabularyRetrieveResponse,
  };

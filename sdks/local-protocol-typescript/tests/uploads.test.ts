import fs from 'fs';
import type { ResponseLike } from 'local-protocol/internal/to-file';
import { toFile } from 'local-protocol/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('local-protocol/core/uploads');
    await expect(

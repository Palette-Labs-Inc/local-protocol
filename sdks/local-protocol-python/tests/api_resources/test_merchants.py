...
from local_protocol.types import MerchantRetrieveResponse
...
class TestMerchants:
    ...
    def test_method_retrieve(self, client: LocalProtocol) -> None:
        ...
        assert_matches_type(MerchantRetrieveResponse, merchant, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_retrieve(self, client: LocalProtocol) -> None:
        response = client.merchants.with_raw_response.retrieve(
            "merchant_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: LocalProtocol) -> None:
        with client.merchants.with_streaming_response.retrieve(
            "merchant_id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: LocalProtocol) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `merchant_id` but received ''"):
            client.merchants.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncMerchants:
    ...
    async def test_method_retrieve(self, async_client: AsyncLocalProtocol) -> None:
        merchant = await async_client.merchants.retrieve(
            "merchant_id",
        )
        assert_matches_type(MerchantRetrieveResponse, merchant, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncLocalProtocol) -> None:
        response = await async_client.merchants.with_raw_response.retrieve(
            "merchant_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncLocalProtocol) -> None:
        async with async_client.merchants.with_streaming_response.retrieve(
            "merchant_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncLocalProtocol) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `merchant_id` but received ''"):
            await async_client.merchants.with_raw_response.retrieve(
                "",
            )

...
use LocalProtocol\Utils\Retry\RetryConfig;
...
class SDKConfiguration
{
    ...
    public string $userAgent = 'speakeasy-sdk/php 0.4.0 2.812.2 0.1.0 localprotocol/local-protocol-sdk';
    ...
    public function getServerUrl(): string
    {
        ...
        if (isset(LocalProtocol::SERVERS[$this->serverIndex])) {
            return LocalProtocol::SERVERS[$this->serverIndex];
        } else {
    ...
    public function getServerDetails(): Utils\ServerDetails
    {
        ...
        return new Utils\ServerDetails(LocalProtocol::SERVERS[$this->serverIndex], []);

...
use LocalProtocol\Utils\Retry;

/**
 * LocalProtocolBuilder is used to configure and build an instance of the SDK.
 */
class LocalProtocolBuilder
{
     ...
     */
    public function setClient(\GuzzleHttp\ClientInterface $client): LocalProtocolBuilder
    {
     ...
     * @return LocalProtocolBuilder
     */
    public function setServerUrl(string $serverUrl, ?array $params = null): LocalProtocolBuilder
    {
     ...
     * @return LocalProtocolBuilder
     */
    public function setServerIndex(int $serverIdx): LocalProtocolBuilder
    {
    ...
    public function setRetryConfig(Retry\RetryConfig $config): LocalProtocolBuilder
    {
     ...
     */
    public function build(): LocalProtocol
    {
        ...
        return new LocalProtocol($this->sdkConfig);
    }
}
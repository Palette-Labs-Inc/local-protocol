...
**max_amount** | [**\LocalProtocolSdk\Model\Amount**](Amount.md) | Maximum authorizable amount (atomic units). |
...
**amount** | [**\LocalProtocolSdk\Model\Amount**](Amount.md) | Amount in atomic units. |

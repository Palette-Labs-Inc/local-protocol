...
class DeliveryQuote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setPrice($price)
    {
        ...
        if (($price < 0)) {
            throw new \InvalidArgumentException('invalid value for $price when calling DeliveryQuote., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling DeliveryQuote., must conform to the pattern /^[A-Z]{3}$/.");
        }
     ...
     * Sets request_id
     *
     * @param string $request_id Reference to the parent delivery request.
     *
     * @return self
     */

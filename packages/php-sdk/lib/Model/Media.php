...
class Media implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Media type discriminator.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url URL to the media resource.
     *
     * @return self
     */
     ...
     * Sets alt_text
     *
     * @param string|null $alt_text Accessibility text describing the media.
     *
     * @return self
     */
    ...
    public function setWidth($width)
    {
        ...
        if (($width < 1)) {
            throw new \InvalidArgumentException('invalid value for $width when calling Media., must be bigger than or equal to 1.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (($height < 1)) {
            throw new \InvalidArgumentException('invalid value for $height when calling Media., must be bigger than or equal to 1.');
        }
